...
Les sections suivantes présentent des jeux de données réels ou publics bien adaptés à la régression logistique (binaire puis multiclasse). Chaque démo indique où télécharger les données, la cible à prédire et pourquoi le problème se prête à ce chapitre.

### 5. LBNL HVAC Fault Detection Dataset (HVAC / contrôles)
