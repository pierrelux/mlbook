...
Cet exemple illustre que l'EMV peut donner des résultats extrêmes avec peu de données. L'approche bayésienne, avec un a priori, permet de modérer ces estimations.
```
