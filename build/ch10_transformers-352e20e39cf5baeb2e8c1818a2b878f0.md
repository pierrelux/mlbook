...
L'animation interactive ci-dessous permet d'explorer l'encodage positionnel en détail: ajuster les dimensions $d$ et la longueur $T$, isoler des paires sin/cos individuelles pour observer les fréquences, et visualiser la similarité cosinus entre positions pour constater l'invariance par translation.
