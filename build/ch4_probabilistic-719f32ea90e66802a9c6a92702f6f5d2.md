...
````{admonition} Exercice 6: Prédicteur de Bayes optimal (perte quadratique) ★★
:class: hint dropdown
...
````{admonition} Exercice 7: Prédicteur de Bayes optimal (perte 0-1) ★★
:class: hint dropdown
...
````{admonition} Exercice 8: Inférence bayésienne complète ★★★
:class: hint dropdown
...
````{admonition} Exercice 9: Entropie croisée et divergence de Kullback-Leibler ★★★
:class: hint dropdown
