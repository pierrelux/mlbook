...
# Add annotations for the regions - positioned based on actual data
ax.annotate('Surapprentissage\n(haute variance)', xy=(8, 0.08), fontsize=10, 
            ha='center', color='gray')
ax.annotate('Sous-apprentissage\n(haut biais)', xy=(80, 0.32), fontsize=10, 
            ha='center', color='gray')
ax.annotate(f'$k^* = {best_k}$', xy=(best_k, test_errors[best_idx]), 
            xytext=(best_k + 20, test_errors[best_idx] + 0.05),
...
# Add secondary interpretation (complexity decreases as k increases)
ax.text(0.5, 0.02, r'complexité du modèle $\longleftarrow$', transform=ax.transAxes, 
