...
````{admonition} Exercice 5: JVP de la couche affine ★★
:class: hint dropdown
...
````{admonition} Exercice 6: du graphe à l'expression (chaîne linéaire) ★
:class: hint dropdown
...
````{admonition} Exercice 7: du graphe à l'expression (embranchement) ★
:class: hint dropdown
...
````{admonition} Exercice 5: du graphe à l'expression (trois entrées) ★
:class: hint dropdown
...
````{admonition} Exercice 6: de l'expression au graphe (embranchement simple) ★
:class: hint dropdown
...
````{admonition} Exercice 7: de l'expression au graphe (diamant) ★
:class: hint dropdown
...
````{admonition} Exercice 5: de l'expression au graphe (triple embranchement) ★★
:class: hint dropdown
...
````{admonition} Exercice 6: des jacobiennes aux VJPs (chaîne linéaire) ★★
:class: hint dropdown
...
````{admonition} Exercice 7: jacobiennes et accumulation (embranchement) ★★
:class: hint dropdown
...
````{admonition} Exercice 5: ReLU et gradient nul ★★★
:class: hint dropdown
