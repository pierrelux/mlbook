...
Minsky et Papert ont montré en 1969 {cite}`minsky1969perceptrons` que le perceptron --- qui trace une frontière linéaire --- ne peut pas apprendre XOR. Leur résultat a été interprété comme une limitation fondamentale des réseaux de neurones, contribuant à un ralentissement de la recherche pendant plusieurs années.

Ce que leur analyse a également montré, sans que cela soit toujours mis en avant, c'est que l'empilage de deux couches de perceptrons résout le problème. L'idée est de d'abord transformer les entrées dans un espace où les classes deviennent séparables linéairement, puis d'appliquer un classifieur linéaire dans cet espace transformé.
