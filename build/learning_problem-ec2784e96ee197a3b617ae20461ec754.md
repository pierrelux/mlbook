...
ax.set_xticks(degrees_to_plot + [10]) # On garde les ticks pour les exemples montrés
ax.grid(True, which="both", ls="-", alpha=0.2)
ax.legend()

# Annotations pour expliquer le graphique
ax.annotate('Sous-apprentissage', xy=(1, all_train_errors[0]), xytext=(3, all_train_errors[0]*5),
            arrowprops=dict(arrowstyle='->'))
ax.annotate('Surapprentissage', xy=(15, all_test_errors[-1]), xytext=(10, all_test_errors[-1]/100),
            arrowprops=dict(arrowstyle='->'))
