...
L'EMV est donc un cas particulier du MAP: celui où nous n'avons aucune préférence a priori sur les paramètres. En d'autres termes, le MLE suppose implicitement que toutes les valeurs de paramètres sont également plausibles avant d'observer les données.
