...
Les **arbres k-d** (k-dimensional trees) partitionnent récursivement l'espace en régions. À chaque nœud, l'espace est divisé selon une dimension, alternant entre les dimensions à chaque niveau. La recherche du plus proche voisin exploite cette structure: si la requête est loin de la frontière de division, des sous-arbres entiers peuvent être élagués sans examiner leurs points.
