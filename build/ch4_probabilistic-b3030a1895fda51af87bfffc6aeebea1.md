...
Le [chapitre précédent](ch4_generalization.md) a exploré les outils pour évaluer et sélectionner des modèles. Nous avons vu la régression linéaire ([chapitre 2](ch2_linear_regression.md)) minimiser la perte quadratique, et la classification ([chapitre 3](ch3_classification.md)) minimiser l'entropie croisée. Mais pourquoi exactement ces choix de fonctions de perte? Ce chapitre répond à cette question en présentant le **cadre probabiliste**, qui offre une fondation principielle pour ces choix.
