...
titles  = ['SGD (zigzags)', r'SGD + Momentum ($\beta=0{,}9$)']
...
Sur cette surface allongée, SGD zigzague entre les parois de la vallée et progresse lentement vers le minimum. Le momentum accumule de la vitesse dans la direction $\theta_1$ (la direction de la vallée) et amortit les oscillations dans la direction $\theta_2$ (perpendiculaire aux parois).
