...
La rétropropagation applique le mode arrière à un réseau en chaîne. Mais les programmes réels ont des structures plus riches: des variables utilisées plusieurs fois, des branchements, des boucles. La suite de cette section montre comment la différentiation automatique généralise ces idées à des graphes de calcul arbitraires.
