...
**Cible binaire simple** : « Rayure » (*Scratch*) vs « non rayure » (fusionner les autres classes). Ensuite, **multiclasse** : type de défaut (Pastry, Z_Scratch, K_Scatch, Stains, Dirtiness, Bumps, Other).
