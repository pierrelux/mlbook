...
# Illustration: k-moyennes (frontière rigide) vs GMM (frontière adaptée)
...
# Frontière de décision k-moyennes (colorier la grille)
...
ax.set_xlabel('$x_1$')
ax.set_ylabel('$x_2$')
ax.set_title(f'K-moyennes: frontière rigide ({n_errors_km} erreurs)')
...
ax.set_xlabel('$x_1$')
ax.set_ylabel('$x_2$')
ax.set_title(f'GMM: frontière adaptée ({n_errors_gmm} erreurs)')
ax.set_xlim(x_min, x_max)
ax.set_ylim(y_min, y_max)
ax.set_aspect('equal')
ax.grid(True, alpha=0.3)
