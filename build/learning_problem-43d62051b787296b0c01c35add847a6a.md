...
Cette idée générale — remplacer une intégrale par une somme pondérée de valeurs de $g$ évaluées à des points $x_m$ — s'appelle **l'intégration numérique** (ou **quadrature**).
...
fig, ax = plt.subplots(figsize=(8, 5))
ax.plot(degrees, train_errors, 'o-', linewidth=2, label='Erreur entraînement')
ax.plot(degrees, test_errors, 's-', linewidth=2, label='Erreur test')
...
# Annotations pour expliquer le graphique
ax.annotate('Sous-apprentissage', xy=(1, train_errors[0]), xytext=(2, train_errors[0]*5),
            arrowprops=dict(arrowstyle='->'))
ax.annotate('Surapprentissage', xy=(15, test_errors[-1]), xytext=(10, test_errors[-1]/100),
            arrowprops=dict(arrowstyle='->'))
